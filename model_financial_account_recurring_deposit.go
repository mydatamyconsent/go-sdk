...
// FinancialAccountRecurringDeposit struct for FinancialAccountRecurringDeposit
type FinancialAccountRecurringDeposit struct {
...
func NewFinancialAccountRecurringDeposit(type_ string, id string, name string, identifier string, amount float64) *FinancialAccountRecurringDeposit {
	this := FinancialAccountRecurringDeposit{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o FinancialAccountRecurringDeposit) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountRecurringDeposit struct {
	value *FinancialAccountRecurringDeposit
	isSet bool
}

func (v NullableFinancialAccountRecurringDeposit) Get() *FinancialAccountRecurringDeposit {
	return v.value
}

func (v *NullableFinancialAccountRecurringDeposit) Set(val *FinancialAccountRecurringDeposit) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountRecurringDeposit) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountRecurringDeposit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountRecurringDeposit(val *FinancialAccountRecurringDeposit) *NullableFinancialAccountRecurringDeposit {
	return &NullableFinancialAccountRecurringDeposit{value: val, isSet: true}
}

func (v NullableFinancialAccountRecurringDeposit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountRecurringDeposit) UnmarshalJSON(src []byte) error {
	v.isSet = true
