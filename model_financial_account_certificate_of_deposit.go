...
// FinancialAccountCertificateOfDeposit struct for FinancialAccountCertificateOfDeposit
type FinancialAccountCertificateOfDeposit struct {
...
func NewFinancialAccountCertificateOfDeposit(type_ string, id string, name string, identifier string, amount float64) *FinancialAccountCertificateOfDeposit {
	this := FinancialAccountCertificateOfDeposit{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o FinancialAccountCertificateOfDeposit) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountCertificateOfDeposit struct {
	value *FinancialAccountCertificateOfDeposit
	isSet bool
}

func (v NullableFinancialAccountCertificateOfDeposit) Get() *FinancialAccountCertificateOfDeposit {
	return v.value
}

func (v *NullableFinancialAccountCertificateOfDeposit) Set(val *FinancialAccountCertificateOfDeposit) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountCertificateOfDeposit) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountCertificateOfDeposit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountCertificateOfDeposit(val *FinancialAccountCertificateOfDeposit) *NullableFinancialAccountCertificateOfDeposit {
	return &NullableFinancialAccountCertificateOfDeposit{value: val, isSet: true}
}

func (v NullableFinancialAccountCertificateOfDeposit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountCertificateOfDeposit) UnmarshalJSON(src []byte) error {
	v.isSet = true
