...
func (r ApiV1DataProvidersGetRequest) Execute() (DataProviderPaginatedList, *_nethttp.Response, error) {
...
*/
func (a *DataProviderDiscoveryApiService) V1DataProvidersGet(ctx _context.Context) ApiV1DataProvidersGetRequest {
	return ApiV1DataProvidersGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DataProviderDiscoveryApiService) V1DataProvidersGetExecute(r ApiV1DataProvidersGetRequest) (DataProviderPaginatedList, *_nethttp.Response, error) {
	var (
...
func (r ApiV1DataProvidersProviderIdGetRequest) Execute() (DataProvider, *_nethttp.Response, error) {
...
*/
func (a *DataProviderDiscoveryApiService) V1DataProvidersProviderIdGet(ctx _context.Context, providerId string) ApiV1DataProvidersProviderIdGetRequest {
	return ApiV1DataProvidersProviderIdGetRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return DataProvider
func (a *DataProviderDiscoveryApiService) V1DataProvidersProviderIdGetExecute(r ApiV1DataProvidersProviderIdGetRequest) (DataProvider, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
