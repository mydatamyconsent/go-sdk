...
func (o Invit) MarshalJSON() ([]byte, error) {
...
type NullableInvit struct {
	value *Invit
	isSet bool
}

func (v NullableInvit) Get() *Invit {
	return v.value
}

func (v *NullableInvit) Set(val *Invit) {
	v.value = val
	v.isSet = true
}

func (v NullableInvit) IsSet() bool {
	return v.isSet
}

func (v *NullableInvit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvit(val *Invit) *NullableInvit {
	return &NullableInvit{value: val, isSet: true}
}

func (v NullableInvit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvit) UnmarshalJSON(src []byte) error {
	v.isSet = true
