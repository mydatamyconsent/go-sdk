...
// FinancialAccountUlip struct for FinancialAccountUlip
type FinancialAccountUlip struct {
...
func (o FinancialAccountUlip) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountUlip struct {
	value *FinancialAccountUlip
	isSet bool
}

func (v NullableFinancialAccountUlip) Get() *FinancialAccountUlip {
	return v.value
}

func (v *NullableFinancialAccountUlip) Set(val *FinancialAccountUlip) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountUlip) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountUlip) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountUlip(val *FinancialAccountUlip) *NullableFinancialAccountUlip {
	return &NullableFinancialAccountUlip{value: val, isSet: true}
}

func (v NullableFinancialAccountUlip) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountUlip) UnmarshalJSON(src []byte) error {
	v.isSet = true
