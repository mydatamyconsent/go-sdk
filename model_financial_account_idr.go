...
// FinancialAccountIdr struct for FinancialAccountIdr
type FinancialAccountIdr struct {
...
func (o FinancialAccountIdr) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountIdr struct {
	value *FinancialAccountIdr
	isSet bool
}

func (v NullableFinancialAccountIdr) Get() *FinancialAccountIdr {
	return v.value
}

func (v *NullableFinancialAccountIdr) Set(val *FinancialAccountIdr) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountIdr) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountIdr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountIdr(val *FinancialAccountIdr) *NullableFinancialAccountIdr {
	return &NullableFinancialAccountIdr{value: val, isSet: true}
}

func (v NullableFinancialAccountIdr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountIdr) UnmarshalJSON(src []byte) error {
	v.isSet = true
