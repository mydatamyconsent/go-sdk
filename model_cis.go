...
func (o CIS) MarshalJSON() ([]byte, error) {
...
type NullableCIS struct {
	value *CIS
	isSet bool
}

func (v NullableCIS) Get() *CIS {
	return v.value
}

func (v *NullableCIS) Set(val *CIS) {
	v.value = val
	v.isSet = true
}

func (v NullableCIS) IsSet() bool {
	return v.isSet
}

func (v *NullableCIS) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCIS(val *CIS) *NullableCIS {
	return &NullableCIS{value: val, isSet: true}
}

func (v NullableCIS) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCIS) UnmarshalJSON(src []byte) error {
	v.isSet = true
