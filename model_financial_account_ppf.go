...
// FinancialAccountPpf struct for FinancialAccountPpf
type FinancialAccountPpf struct {
...
func (o FinancialAccountPpf) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountPpf struct {
	value *FinancialAccountPpf
	isSet bool
}

func (v NullableFinancialAccountPpf) Get() *FinancialAccountPpf {
	return v.value
}

func (v *NullableFinancialAccountPpf) Set(val *FinancialAccountPpf) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountPpf) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountPpf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountPpf(val *FinancialAccountPpf) *NullableFinancialAccountPpf {
	return &NullableFinancialAccountPpf{value: val, isSet: true}
}

func (v NullableFinancialAccountPpf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountPpf) UnmarshalJSON(src []byte) error {
	v.isSet = true
