...
// FinancialAccountBillPayment struct for FinancialAccountBillPayment
type FinancialAccountBillPayment struct {
...
func NewFinancialAccountBillPayment(type_ string, id string, name string, identifier string, amount float64) *FinancialAccountBillPayment {
	this := FinancialAccountBillPayment{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o FinancialAccountBillPayment) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountBillPayment struct {
	value *FinancialAccountBillPayment
	isSet bool
}

func (v NullableFinancialAccountBillPayment) Get() *FinancialAccountBillPayment {
	return v.value
}

func (v *NullableFinancialAccountBillPayment) Set(val *FinancialAccountBillPayment) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountBillPayment) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountBillPayment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountBillPayment(val *FinancialAccountBillPayment) *NullableFinancialAccountBillPayment {
	return &NullableFinancialAccountBillPayment{value: val, isSet: true}
}

func (v NullableFinancialAccountBillPayment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountBillPayment) UnmarshalJSON(src []byte) error {
	v.isSet = true
