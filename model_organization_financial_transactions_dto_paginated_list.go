...
// OrganizationFinancialTransactionsDtoPaginatedList struct for OrganizationFinancialTransactionsDtoPaginatedList
type OrganizationFinancialTransactionsDtoPaginatedList struct {
	PageIndex *int32 `json:"pageIndex,omitempty"`
	PageSize *int32 `json:"pageSize,omitempty"`
	TotalPages *int32 `json:"totalPages,omitempty"`
	TotalItems *int64 `json:"totalItems,omitempty"`
	Items []OrganizationFinancialTransactionsDto `json:"items,omitempty"`
}
...
func NewOrganizationFinancialTransactionsDtoPaginatedList() *OrganizationFinancialTransactionsDtoPaginatedList {
	this := OrganizationFinancialTransactionsDtoPaginatedList{}
	return &this
}
...
// SetItems gets a reference to the given []OrganizationFinancialTransactionsDto and assigns it to the Items field.
func (o *OrganizationFinancialTransactionsDtoPaginatedList) SetItems(v []OrganizationFinancialTransactionsDto) {
	o.Items = v
}

func (o OrganizationFinancialTransactionsDtoPaginatedList) MarshalJSON() ([]byte, error) {
...
type NullableOrganizationFinancialTransactionsDtoPaginatedList struct {
	value *OrganizationFinancialTransactionsDtoPaginatedList
	isSet bool
}

func (v NullableOrganizationFinancialTransactionsDtoPaginatedList) Get() *OrganizationFinancialTransactionsDtoPaginatedList {
	return v.value
}

func (v *NullableOrganizationFinancialTransactionsDtoPaginatedList) Set(val *OrganizationFinancialTransactionsDtoPaginatedList) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationFinancialTransactionsDtoPaginatedList) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationFinancialTransactionsDtoPaginatedList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationFinancialTransactionsDtoPaginatedList(val *OrganizationFinancialTransactionsDtoPaginatedList) *NullableOrganizationFinancialTransactionsDtoPaginatedList {
	return &NullableOrganizationFinancialTransactionsDtoPaginatedList{value: val, isSet: true}
}

func (v NullableOrganizationFinancialTransactionsDtoPaginatedList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationFinancialTransactionsDtoPaginatedList) UnmarshalJSON(src []byte) error {
	v.isSet = true
