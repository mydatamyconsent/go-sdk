...
// FinancialAccountGovtSecurity struct for FinancialAccountGovtSecurity
type FinancialAccountGovtSecurity struct {
...
func NewFinancialAccountGovtSecurity(type_ string, id string, name string, identifier string, amount float64) *FinancialAccountGovtSecurity {
	this := FinancialAccountGovtSecurity{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o FinancialAccountGovtSecurity) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountGovtSecurity struct {
	value *FinancialAccountGovtSecurity
	isSet bool
}

func (v NullableFinancialAccountGovtSecurity) Get() *FinancialAccountGovtSecurity {
	return v.value
}

func (v *NullableFinancialAccountGovtSecurity) Set(val *FinancialAccountGovtSecurity) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountGovtSecurity) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountGovtSecurity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountGovtSecurity(val *FinancialAccountGovtSecurity) *NullableFinancialAccountGovtSecurity {
	return &NullableFinancialAccountGovtSecurity{value: val, isSet: true}
}

func (v NullableFinancialAccountGovtSecurity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountGovtSecurity) UnmarshalJSON(src []byte) error {
	v.isSet = true
