...
// FinancialAccountLoan struct for FinancialAccountLoan
type FinancialAccountLoan struct {
...
func (o FinancialAccountLoan) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountLoan struct {
	value *FinancialAccountLoan
	isSet bool
}

func (v NullableFinancialAccountLoan) Get() *FinancialAccountLoan {
	return v.value
}

func (v *NullableFinancialAccountLoan) Set(val *FinancialAccountLoan) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountLoan) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountLoan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountLoan(val *FinancialAccountLoan) *NullableFinancialAccountLoan {
	return &NullableFinancialAccountLoan{value: val, isSet: true}
}

func (v NullableFinancialAccountLoan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountLoan) UnmarshalJSON(src []byte) error {
	v.isSet = true
