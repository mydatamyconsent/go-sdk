...
// FinancialAccountBond struct for FinancialAccountBond
type FinancialAccountBond struct {
...
func (o FinancialAccountBond) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountBond struct {
	value *FinancialAccountBond
	isSet bool
}

func (v NullableFinancialAccountBond) Get() *FinancialAccountBond {
	return v.value
}

func (v *NullableFinancialAccountBond) Set(val *FinancialAccountBond) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountBond) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountBond) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountBond(val *FinancialAccountBond) *NullableFinancialAccountBond {
	return &NullableFinancialAccountBond{value: val, isSet: true}
}

func (v NullableFinancialAccountBond) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountBond) UnmarshalJSON(src []byte) error {
	v.isSet = true
