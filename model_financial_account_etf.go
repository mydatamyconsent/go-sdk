...
// FinancialAccountEtf struct for FinancialAccountEtf
type FinancialAccountEtf struct {
...
func (o FinancialAccountEtf) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountEtf struct {
	value *FinancialAccountEtf
	isSet bool
}

func (v NullableFinancialAccountEtf) Get() *FinancialAccountEtf {
	return v.value
}

func (v *NullableFinancialAccountEtf) Set(val *FinancialAccountEtf) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountEtf) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountEtf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountEtf(val *FinancialAccountEtf) *NullableFinancialAccountEtf {
	return &NullableFinancialAccountEtf{value: val, isSet: true}
}

func (v NullableFinancialAccountEtf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountEtf) UnmarshalJSON(src []byte) error {
	v.isSet = true
