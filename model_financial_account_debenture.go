...
// FinancialAccountDebenture struct for FinancialAccountDebenture
type FinancialAccountDebenture struct {
...
func NewFinancialAccountDebenture(type_ string, id string, name string, identifier string, amount float64) *FinancialAccountDebenture {
	this := FinancialAccountDebenture{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o FinancialAccountDebenture) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountDebenture struct {
	value *FinancialAccountDebenture
	isSet bool
}

func (v NullableFinancialAccountDebenture) Get() *FinancialAccountDebenture {
	return v.value
}

func (v *NullableFinancialAccountDebenture) Set(val *FinancialAccountDebenture) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountDebenture) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountDebenture) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountDebenture(val *FinancialAccountDebenture) *NullableFinancialAccountDebenture {
	return &NullableFinancialAccountDebenture{value: val, isSet: true}
}

func (v NullableFinancialAccountDebenture) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountDebenture) UnmarshalJSON(src []byte) error {
	v.isSet = true
