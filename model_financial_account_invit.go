...
// FinancialAccountInvit struct for FinancialAccountInvit
type FinancialAccountInvit struct {
...
func (o FinancialAccountInvit) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountInvit struct {
	value *FinancialAccountInvit
	isSet bool
}

func (v NullableFinancialAccountInvit) Get() *FinancialAccountInvit {
	return v.value
}

func (v *NullableFinancialAccountInvit) Set(val *FinancialAccountInvit) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountInvit) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountInvit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountInvit(val *FinancialAccountInvit) *NullableFinancialAccountInvit {
	return &NullableFinancialAccountInvit{value: val, isSet: true}
}

func (v NullableFinancialAccountInvit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountInvit) UnmarshalJSON(src []byte) error {
	v.isSet = true
