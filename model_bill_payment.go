...
// BillPayment struct for BillPayment
...
func (o BillPayment) MarshalJSON() ([]byte, error) {
...
type NullableBillPayment struct {
	value *BillPayment
	isSet bool
}

func (v NullableBillPayment) Get() *BillPayment {
	return v.value
}

func (v *NullableBillPayment) Set(val *BillPayment) {
	v.value = val
	v.isSet = true
}

func (v NullableBillPayment) IsSet() bool {
	return v.isSet
}

func (v *NullableBillPayment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillPayment(val *BillPayment) *NullableBillPayment {
	return &NullableBillPayment{value: val, isSet: true}
}

func (v NullableBillPayment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillPayment) UnmarshalJSON(src []byte) error {
	v.isSet = true
