...
// FinancialAccountDeposit struct for FinancialAccountDeposit
type FinancialAccountDeposit struct {
...
func (o FinancialAccountDeposit) MarshalJSON() ([]byte, error) {
...
type NullableFinancialAccountDeposit struct {
	value *FinancialAccountDeposit
	isSet bool
}

func (v NullableFinancialAccountDeposit) Get() *FinancialAccountDeposit {
	return v.value
}

func (v *NullableFinancialAccountDeposit) Set(val *FinancialAccountDeposit) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialAccountDeposit) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialAccountDeposit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialAccountDeposit(val *FinancialAccountDeposit) *NullableFinancialAccountDeposit {
	return &NullableFinancialAccountDeposit{value: val, isSet: true}
}

func (v NullableFinancialAccountDeposit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialAccountDeposit) UnmarshalJSON(src []byte) error {
	v.isSet = true
