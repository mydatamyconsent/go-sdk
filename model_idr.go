...
func (o Idr) MarshalJSON() ([]byte, error) {
...
type NullableIdr struct {
	value *Idr
	isSet bool
}

func (v NullableIdr) Get() *Idr {
	return v.value
}

func (v *NullableIdr) Set(val *Idr) {
	v.value = val
	v.isSet = true
}

func (v NullableIdr) IsSet() bool {
	return v.isSet
}

func (v *NullableIdr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdr(val *Idr) *NullableIdr {
	return &NullableIdr{value: val, isSet: true}
}

func (v NullableIdr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdr) UnmarshalJSON(src []byte) error {
	v.isSet = true
